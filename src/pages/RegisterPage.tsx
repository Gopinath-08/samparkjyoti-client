...
const Step = styled.div<{ $active: boolean; $completed: boolean }>`
  ...
  justify-content: center;
  margin: 0 0.5rem;
  background: ${props => props.$completed ? 'var(--color-sea-green)' : props.$active ? 'var(--color-saddle-brown)' : 'var(--color-border)'};
  color: ${props => props.$completed || props.$active ? 'var(--color-pure-white)' : 'var(--color-dim-gray)'};
  font-weight: 600;
...
const RegisterPage: React.FC = () => {
  ...
  const renderStep2 = () => (
    <>
      ...
      <div>
        <h3 style={{ marginBottom: '1rem', color: 'var(--color-saddle-brown)' }}>Select Your Role(s)</h3>
        <RoleGrid>
      ...
      {selectedRoles.length > 1 && (
        <div>
          <h3 style={{ marginBottom: '1rem', color: 'var(--color-saddle-brown)' }}>Primary Role</h3>
          <Select
      ...
      <div>
        <h3 style={{ marginBottom: '1rem', color: 'var(--color-saddle-brown)' }}>Languages</h3>
        <LanguageGrid>
      ...
      {selectedRoles.includes('labour') && (
        <div>
          <h3 style={{ marginBottom: '1rem', color: 'var(--color-saddle-brown)' }}>Labour Details</h3>
          <InputGroup>
            <Input
              type="number"
              placeholder="Age"
      ...
      {selectedRoles.includes('farmer') && (
        <div>
          <h3 style={{ marginBottom: '1rem', color: 'var(--color-saddle-brown)' }}>Farmer Details</h3>
          <Select
      ...
      {selectedRoles.includes('employer') && (
        <div>
          <h3 style={{ marginBottom: '1rem', color: 'var(--color-saddle-brown)' }}>Business Details</h3>
          <InputGroup>
            <Input
              type="text"
